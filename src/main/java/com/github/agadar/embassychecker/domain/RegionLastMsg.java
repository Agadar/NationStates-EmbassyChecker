...
/**
 * A region name with the time difference in days between when the last message
...
public final class RegionLastMsg implements Comparable<RegionLastMsg> {
    ...
    /**
     * Time difference in days between when the last message was posted on the
     * region's message board and now.
     */
     ...
     * @param diffInSeconds time difference in seconds between when the last
